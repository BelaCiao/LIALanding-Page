...
export const LiaLogo: React.FC = () => (
    <div className="h-10 w-10 bg-gradient-to-br from-blue-500 to-teal-400 rounded-lg flex items-center justify-center shadow-lg">
...
export const LiaAiIcon: React.FC = () => (
...
export const DoubleCheckIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-500" fill="currentColor" viewBox="0 0 16 16">
